...
from src.caption import CaptionGenerationConfig, create_caption_generation_datasets
...
@hydra.main(version_base=None, config_path="../../../config", config_name="caption_dataset")
