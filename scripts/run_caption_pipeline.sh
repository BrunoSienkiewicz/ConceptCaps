...
#SBATCH --output=logs/caption_pipeline/${SLURM_JOB_ID}.out
#SBATCH --error=logs/caption_pipeline/${SLURM_JOB_ID}.err
...
mkdir -p "$HF_HOME"
srun "$ENV_DIR/bin/python" src/scripts/caption/run_pipeline.py "${HYDRA_OVERRIDES[@]}"
