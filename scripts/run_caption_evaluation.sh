#!/bin/bash -l
#SBATCH -J run_caption_evaluation
#SBATCH -N 1
...
#SBATCH --output=logs/caption_evaluation.out
#SBATCH --error=logs/caption_evaluation.err
...
mkdir -p "$HF_HOME"
srun "$ENV_DIR/bin/python" src/scripts/caption/run_evaluation.py "${HYDRA_OVERRIDES[@]}"